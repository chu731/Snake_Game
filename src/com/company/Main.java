...
public class Main extends JPanel implements KeyListener {
    ...
    public static int row = hight / CELL_SIZE;
    ...
    public static void main(String[] args) {
        ...
        window.setResizable(false); //無法調整視窗
    }
